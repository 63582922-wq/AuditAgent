export const zh = {
  ...
  outputsPage: {
    ...
    acceptFail: "验收失败，请重试",
    rejectFail: "退回失败，请重试",
    deliveryBlockedTitle: "正式验收已阻断",
    deliveryBlockedHint: "当前仅可下载预览交付物，不能标记为已验收。",
    deliveryBlockedAction: "请在审核结论中完成逐条复核，补齐资料或重跑后再验收。",
    deliveryBlockEvidence: "关键事实证据待复核",
    deliveryBlockEvaluation: "自动评估存在严重失败",
    deliveryBlockTemplate: "143 列固定模板尚未达到门禁",
    deliveryBlockOutputs: "固定模板 Excel 或 ZIP 归档缺失",
